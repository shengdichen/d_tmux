...
# a cleaner, one-line look {{{
# only show one line
set-option -g status on

# place the statusline at the bottom for minimal distraction
set-option -g status-position bottom


# hide both left and right components
# center component displays window info and is set previously
set-option -g status-left ''
set-option -g status-right ''
# }}}

# go even further and disable the status-line as well {{{
